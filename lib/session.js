...
// Re-locking (clicking the unlocked padlock) never needs the password,
// same as closing a real lock — only opening it does.
export function lockRoster() {
  cookies().delete(ROSTER_GATE_COOKIE);
}
