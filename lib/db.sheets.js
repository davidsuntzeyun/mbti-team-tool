...
async function getSheetsClient() {
  ...
  if (
    (privateKey.startsWith(String.fromCharCode(34)) && privateKey.endsWith(String.fromCharCode(34))) ||
    (privateKey.startsWith(String.fromCharCode(39)) && privateKey.endsWith(String.fromCharCode(39)))
  ) {
  ...
  console.error("GOOGLE_PRIVATE_KEY diagnostic:", {
